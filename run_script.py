...
config_file = "driver_config.yaml"
obj = Modbus_Driver(config_file=config_file)
obj.initialize_modbus()

local_db = Influx_Database_class(config_file=config_file, config_type="local")
remote_db = Influx_Database_class(config_file=config_file, config_type="remote")
